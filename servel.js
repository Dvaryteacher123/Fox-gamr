...
// ============================================================
// API ENDPOINT - AI CHAT (Inatumia OpenRouter SDK mpya)
// ============================================================
app.post('/api/ai-chat', async (req, res) => {
    try {
        ...
        // Kuchomoa jibu kutoka kwenye SDK muundo mpya
        const aiResponse = completion.choices?.[0]?.message?.content || completion.content || "Samahani, sijapata jibu sahihi.";
...
app.listen(PORT, () => {
    ...
    console.log(`📌 =============================================`);
    console.log(`📍 Public Routes & AI Chat ready!`);
});
