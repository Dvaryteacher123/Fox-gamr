...
app.post('/api/pay-fimipay', async (req, res) => {
    try {
        ...
        // Kama hakuna email iliyotumwa, tengeneza ya mpito ili kuzuia seva kukataa ombi
        if (!buyer_email) {
            buyer_email = `user_${Date.now()}@dvarygames.com`;
        }

        // Hakikisha namba ya simu inaanza na msimbo wa nchi (255) kama imewekwa kienyeji
